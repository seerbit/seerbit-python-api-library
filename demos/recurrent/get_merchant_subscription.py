...
def get_merchant_subscription(token_str: str):
    """ Get Merchant Subscription """
    print("================== start get merchant subscription ==================")
    recurring_service = RecurringService(client, token_str)
    json_response = recurring_service.get_merchant_subscriptions(client.public_key)
    print("================== stop get merchant subscription ==================")
...
if token:
    print("get customer subscription response: " + str(get_merchant_subscription(token)))
else:
